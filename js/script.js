...
$(document).ready(function () {
  var mainMenu = document.querySelector('.navigation__wrap');
  var mainMenuToggler = document.querySelector('.navigation__burger');
  ...
  document.addEventListener('click', function (evt) {
    ...
    var its_menu = target == mainMenu || mainMenu.contains(target);
    var its_btnMenu = target == mainMenuToggler;
    var menu_is_active = mainMenuToggler.classList.contains('reset-button--opened');
...
var Stickyfill = __webpack_require__(10);
...
$(document).ready(function () {
  var katexGaussian = document.querySelector('#katex-gaussian');
  var katexMartini = document.querySelector('#katex-martini');
